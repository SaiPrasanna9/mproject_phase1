...
class RootFloatLayout(FloatLayout):
    ...
    def come(self):
        try:
            ...
            self.lay= BoxLayout(orientation = 'vertical', padding = (20,0,5,5))
            self.lay1 = BoxLayout(orientation='vertical',padding=(10,0,5,5),spacing=2)
            ...
            for i in (self.rem_list):
                ...
                self.layout = BoxLayout(orientation='horizontal',padding=(10,0,5,5),spacing=20)
                ...
                x = CheckBox(active = False,color=(1,1,1,1),width="200")

                self.cbs[x]=i

                self.layout.add_widget(x)
                self.lay1.add_widget(self.layout)
            ...
            b1=Button(text="Ok",font_size=20,size_hint=(0.2,0.08),pos_hint={"x":0.4},background_color='#e6005c')
    ...
    def okok(self):
        ...
        for rem in self.selected_rem_list.keys():
            a=self.selected_rem_list[rem]
            try:
